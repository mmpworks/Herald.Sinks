...
Sink kind: `axiom` (the identifier the Dashboard form and JSON config use to reference this sink).

## Capabilities

- HTTP POST per batch as a JSON array
- Bearer token auth
- EU / on-prem endpoint override via the baseUrl constructor parameter
