...
Sink kind: `sumologic` (the identifier the Dashboard form and JSON config use to reference this sink).

## Capabilities

- HTTP source POST with NDJSON body
- X-Sumo-Category / -Name / -Host header tagging
- Pure HTTP — no Sumo Logic SDK
...
Sumo Logic — https://help.sumologic.com/docs/send-data/hosted-collectors/http-source/
